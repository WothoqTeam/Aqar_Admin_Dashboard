...
@Component({
  selector: 'app-edit-aqar',
  templateUrl: './edit-aqar.component.html',
  styleUrls: ['./edit-aqar.component.css']
})
export class EditAqarComponent implements OnInit {
  ...
  private setForm() {
    ...
    this.editForm = this.formBuilder.group({
      ...
      unit_number_apartments: [this.selectedAqar.unit_number_apartments, Validators.required],
      land_price: [this.selectedAqar.land_price, Validators.required],
